...
const ReorderPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let stat = await fetch(`${serverURL}/editcontract/reorderDelete`, {
            ...
            body: JSON.stringify({selectedFiles: selectedMembers,SP, EP, id:1})
        }).then((data)=> data.json())
        if(stat.success){
    ...
    return (
        ...
        <br/>
            ...
            <h5>Select the file whose pages need to be reordered:</h5>
            ...
            <div className='form-control'>
                    ...
                    <Button class="btn btn-primary" text="Reorder Pages" onClick={(e)=>handleSubmit(e)} />
